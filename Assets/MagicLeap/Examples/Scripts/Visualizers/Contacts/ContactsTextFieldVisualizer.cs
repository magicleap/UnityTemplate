...
namespace MagicLeap
{
    ...
    public class ContactsTextFieldVisualizer : MonoBehaviour
    {
        ...
        private ContactsButtonVisualizer _button = null;
        ...
        void Awake()
        {
            if (_button == null)
            {
                Debug.LogError("Error: ContactsTextFieldVisualizer._button is not set, disabling script.");
                enabled = false;
                return;
            }
            ...
            if (_label == null)
            {
                Debug.LogError("Error: ContactsTextFieldVisualizer._label is not set, disabling script.");
                enabled = false;
                return;
            }
