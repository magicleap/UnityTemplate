...
namespace MagicLeap
{
    ...
    public class MLWebRTCExample : MonoBehaviour
    {
        ...
        private void OnConnectionTrackAdded(MLWebRTC.MediaStream mediaStream, MLWebRTC.MediaStream.Track addedTrack)
        {
            ...
            switch (addedTrack.TrackType)
            {
                ...
                {
                    remoteAudioSinkBehavior.AudioSink.SetStream(mediaStream);
                ...
                {
                    remoteVideoSinkBehavior.VideoSink.SetStream(mediaStream);
        ...
        private void OnConnectionTrackRemoved(MLWebRTC.MediaStream mediaStream, MLWebRTC.MediaStream.Track removedTrack)
        {
        ...
        private void SubscribeToConnection(MLWebRTC.PeerConnection connection)
        {
            ...
            connection.OnTrackAdded += OnConnectionTrackAdded;
            connection.OnTrackRemoved += OnConnectionTrackRemoved;
