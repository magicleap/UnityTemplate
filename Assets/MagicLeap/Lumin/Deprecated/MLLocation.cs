...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLLocation : MLAPISingleton<MLLocation>
    {
        ...
        {
            return "This function is obsolete. Use MLLocation.GetResultString(MLResult.Code) instead.";
        }
        ...
        /// </returns>
        [Obsolete("Please use GetLastFineLocation with the MLLocation.Location struct instead.")]
        ...
        /// </returns>
        [Obsolete("Please use GetLastCoarseLocation with the MLLocation.Location struct instead.")]
        ...
        /// MLResult.Result will be <c>MLResult.Code.LocationNoLocation</c> if the location could not be found.
        /// </returns>
        [Obsolete("Please use GetLastLocationInternal with the MLLocation.Location struct instead.")]
