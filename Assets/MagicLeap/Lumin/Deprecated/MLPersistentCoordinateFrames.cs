...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLPersistentCoordinateFrames
    {
        ...
        [Obsolete("Please use IsLocalized instead.")]
        public static bool IsReady { get; private set; }

        [Obsolete("Please subscribe to the OnLocalized event instead.")]
        ...
        [Obsolete("Please call directly call Update() using a reference to an MLPersistentCoordinateFrames.PCF object instead.")]
        ...
        [Obsolete("Please use FindAllPCFs instead.")]
        ...
        [Obsolete("This is no longer used, please use MLResult.CodeToString(MLResult.Code) instead.")]
