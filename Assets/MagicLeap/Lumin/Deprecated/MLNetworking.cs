...
// ---------------------------------------------------------------------
// %COPYRIGHTBEGIN%
// <copyright file="MLNetworking.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public static partial class MLNetworking
    {
        ...
        [Obsolete("Deprecated, please use GetResultString(MLResult.Code) instead.", false)]
        public static string GetResultString(MLResultCode resultCode)
        {
            ...
            try
            {
                finalResult = "This function is deprecated. Use MLNetworking.GetResultString(MLResult.Code) instead.";
            }
        ...
        /// </returns>
        [Obsolete("Deprecated, please use GetWifiData with the MLNetworking.WifiData struct instead.", false)]
