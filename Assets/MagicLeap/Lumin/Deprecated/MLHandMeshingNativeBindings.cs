...
// ---------------------------------------------------------------------
// %COPYRIGHTBEGIN%
// <copyright file="MLHandMeshingNativeBindings.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLHandMeshing : MLAPISingleton<MLHandMeshing>
    {
        ...
        private partial class NativeBindings : Native.MagicLeapNativeBindings
        {
            ...
            [Obsolete("Deprecated, please use NativeBindings.MLHandMeshingGetResult(ulong, ulong, NativeBindings.MeshNative) instead.", false)]
            ...
            [Obsolete("Deprecated, please use NativeBindings.MeshNative instead.", false)]
            ...
            /// </summary>
            [StructLayout(LayoutKind.Sequential)]
            [Obsolete("Deprecated, please use NativeBindings.MeshNative.BlockNative instead.", false)]
