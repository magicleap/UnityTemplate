...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public partial struct MLResult
    {
        ...
        /// </summary>
        [Obsolete("MLResult.ResultOk is obsolete. This is no longer needed, use MLResult.Create instead.", false)]
        ...
        [Obsolete("Use MLResult.Create instead. Note the previous MLResult.Code has been replaced with MLResult.Result.", true)]
