...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLMovement.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLMovement
    {
        ...
        /// </returns>
        [Obsolete("Use MLMovement.Settings.Create() instead.")]
        ...
        /// </returns>
        [Obsolete("Use MLMovement.Start3Dof(MLMovement.Settings, MLMovement.Settings3Dof, MLMovement.Controls3Dof, MLMovement.MovementObject, ulong) instead.")]
        ...
        /// MLResult.Result will be <c>MLResult.Code.MovementInvalidMovementHandle</c> if session handle is invalid.
        /// </returns>
        [Obsolete("Use MLMovement.Start6Dof(MLMovement.Settings, MLMovement.Controls6Dof, MLMovement.MovementObject, ulong) instead.")]
        ...
        /// MLResult.Result will be <c>MLResult.Code.MovementInvalidMovementHandle</c> if session handle is invalid.
        /// </returns>
        [Obsolete("Use MLMovement.Update3Dof(ulong, MLMovement.Controls3Dof, float, MLMovement.MovementObject) instead.")]
        ...
        /// MLResult.Result will be <c>MLResult.Code.MovementInvalidMovementHandle</c> if session handle is invalid.
        /// </returns>
        [Obsolete("Use MLMovement.Update6Dof(ulong, MLMovement.Controls6Dof, float, MLMovement.MovementObject) instead.")]
        ...
        /// MLResult.Result will be <c>MLResult.Code.MovementInvalidMovementHandle</c> if session handle is invalid.
        /// </returns>
        [Obsolete("Use MLMovement.End(ulong, float, MLMovement.MovementObject) instead.")]
        ...
        [Obsolete("Use MLResult.CodeToString(MLResult.Code) instead.", true)]
