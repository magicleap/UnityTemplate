...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MLLightingTrackingNativeBindings.cs" company = "Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap.Native
{
    ...
    public partial class MLLightingTrackingNativeBindings : MagicLeapNativeBindings
    {
        ...
        [Obsolete("Use AmbientGlobalStateNative instead.", false)]
        ...
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        [Obsolete("Use ColorTemperatureStateNative instead.", false)]
        ...
        [Obsolete("Use MLLightingTrackingGetColorTemperatureState with ColorTemperatureStateNative instead.", false)]
        ...
        [Obsolete("Use MLLightingTrackingGetAmbientGlobalState with AmbientGlobalStateNative instead.", false)]
        [DllImport(MLPerceptionClientDll, CallingConvention = CallingConvention.Cdecl)]
