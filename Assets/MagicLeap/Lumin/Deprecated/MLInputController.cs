...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MLInputController.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    /// <summary/>
    [Obsolete("use MLInput.Controller instead.", true)]
    ...
    public partial class MLInput : MLAPISingleton<MLInput>
    {
        ...
        public partial class Controller
        {
            ...
            /// </returns>
            [Obsolete("use MLInput.Controller.StartFeedbackPatternLED(MLInput.Controller.FeedbackPatternLED, MLInput.Controller.FeedbackColorLED, float) instead.", false)]
            ...
            /// MLResult.Result will be <c>MLResult.Code.UnspecifiedFailure</c> if failed due to other internal error.
            /// </returns>
            [Obsolete("use MLInput.Controller.StartFeedbackPatternEffectLED(MLInput.Controller.FeedbackEffectLED, MLInput.Controller.FeedbackEffectSpeedLED, MLInput.Controller.FeedbackPatternLED, float) instead.", false)]
            ...
            /// MLResult.Result will be <c>MLResult.Code.UnspecifiedFailure</c> if failed due to other internal error.
            /// </returns>
            [Obsolete("use MLInput.Controller.StartFeedbackPatternVibe(MLInput.Controller.FeedbackPatternVibe, MLInput.Controller.FeedbackIntensity) instead.", false)]
