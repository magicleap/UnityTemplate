...
// ---------------------------------------------------------------------
// %COPYRIGHTBEGIN%
// <copyright file="MLHand.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed class MLHand : MLHandTracking.Hand
    {
        ...
        /// </summary>
        [Obsolete("Please use HandKeyPoseConfidence instead.", true)]
        ...
        /// </summary>
        [Obsolete("Please use HandKeyPoseConfidenceFiltered instead.", true)]
        ...
        /// </summary>
        [Obsolete("Please use OnHandKeyPoseBegin instead.", true)]
        ...
        /// </summary>
        /// <param name="handType">Hand type.</param>
        [Obsolete("Please use MLHand(MLHandTracking.HandType) instead.", true)]
        public MLHand(MLHandType handType) : base (MLHandTracking.HandType.Left)
        {
        }

        [Obsolete("Please use BeginKeyPose(MLHandTracking.HandKeyPose) instead.", true)]
        public void BeginKeyPose(MLHandKeyPose pose)
        {
        }

        [Obsolete("Please use EndKeyPose(MLHandTracking.HandKeyPose) instead.", true)]
