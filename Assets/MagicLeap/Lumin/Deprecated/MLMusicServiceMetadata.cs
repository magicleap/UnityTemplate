...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLMusicServiceMetadata.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    /// </summary>
    [Obsolete("Use MLMusicService.ErrorType instead.", true)]
    ...
    /// MusicService status
    /// </summary>
    [Obsolete("Use MLMusicService.Status instead.", true)]
    ...
    /// </summary>
    [Obsolete("Use MLMusicService.PlaybackStateType instead.", true)]
    ...
    /// </summary>
    [Obsolete("Use MLMusicService.RepeatStateType instead.", true)]
    ...
    /// </summary>
    [Obsolete("Use MLMusicService.ShuffleStateType instead.", true)]
    ...
    /// </summary>
    [Obsolete("Use MLMusicService.TrackType instead.", true)]
    ...
    /// </summary>
    [Obsolete("Use MLMusicService.Metadata instead.", true)]
    ...
    /// </summary>
    [Obsolete("Use MLMusicService.Error instead.", true)]
