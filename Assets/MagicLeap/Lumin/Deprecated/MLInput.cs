...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MLInput.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public partial class MLInput : MLAPISingleton<MLInput>
    {
        ...
        /// </returns>
        [Obsolete("This method has been deprecated, please use the override.", true)]
    ...
    /// </summary>
    [Obsolete("use MLInput.TabletState instead.", true)]
    ...
    /// </summary>
    [Obsolete("use MLInput.Configuration instead.", true)]
    public class MLInputConfiguration
    {
        ...
        /// <param name="triggerUpThreshold">The threshold before the trigger up event occurs.</param>
        /// <param name="enableCFUIDTracking">A flag that indicates if 6DOF will be used.</param>
        [Obsolete("This method has been replaced by MLInput.Configuration(enableCFUIDTracking, triggerDownThreshold, triggerUpThreshold)", true)]
        public MLInputConfiguration(
            float triggerDownThreshold = DEFAULT_TRIGGER_DOWN_THRESHOLD,
            float triggerUpThreshold = DEFAULT_TRIGGER_UP_THRESHOLD,
        ...
        [Obsolete("Use MLInputNativeBindings.MLInputConfigurationNative.Data to cast betwen this structs instead.")]
