...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MagicLeapDevice.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public class MagicLeapDevice : MLDevice
    {
        ...
        [Obsolete("Please use MLDevice.Unregister(Action updateCallback) instead.", true)]
        ...
        /// </summary
        [Obsolete("Please use MLDevice.Register(Action updateCallback) instead.", true)]
