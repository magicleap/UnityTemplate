...
// ---------------------------------------------------------------------
// %COPYRIGHTBEGIN%
// <copyright file="MLNetworkingNativeBindings.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap.Native
{
    ...
    public partial class MLNetworkingNativeBindings : MagicLeapNativeBindings
    {
        ...
        [Obsolete("Deprecated, please use MLNetworkingGetWiFiData with the WifiDataNative struct instead.", false)]
        ...
        [Obsolete("Deprecated, please use MLNetworkingNativeBindings.WifiDataNative instead.", false)]
