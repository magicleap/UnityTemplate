...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MLControllerNativeBindings.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    namespace Native
    {
        ...
        public partial class MLControllerNativeBindings : MagicLeapNativeBindings
        {
            ...
            [Obsolete("use MLInputStartControllerFeedbackPatternVibe(byte, MLInput.Controller.FeedbackPatternVibe, MLInput.Controller.FeedbackIntensity) instead.", false)]
            ...
            [return: MarshalAs(UnmanagedType.I1)]
            [Obsolete("use MLInputStartControllerFeedbackPatternLED(byte, MLInput.Controller.FeedbackPatternLED, MLInput.Controller.FeedbackColorLED, uint) instead.", false)]
            ...
            [return: MarshalAs(UnmanagedType.I1)]
            [Obsolete("use MLInputStartControllerFeedbackPatternEffectLED(byte, MLInput.Controller.FeedbackEffectLED, MLInput.Controller.FeedbackEffectSpeedLED, MLInput.Controller.FeedbackPatternLED, MLInput.Controller.FeedbackColorLED, uint) instead.", false)]
