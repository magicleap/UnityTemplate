...
namespace UnityEngine.XR.MagicLeap
{
    ...
    /// </summary>
    [Obsolete("use MLContacts.OperationStatus instead.", true)]
    ...
    /// </summary>
    [Flags]
    [Obsolete("use MLContacts.SearchField instead.", true)]
    ...
    /// </summary>
    [Flags]
    [Obsolete("use MLContacts.SelectionField instead.", true)]
    ...
    /// </summary>
    [Obsolete("use MLContacts.OperationResult instead.", true)]
    ...
    /// </summary>
    [Obsolete("use MLContacts.ListResult instead.", true)]
    ...
    /// </summary>
    [Obsolete("use MLContacts.ContactList instead.", true)]
    ...
    /// </summary>
    [Obsolete("use MLContacts.TaggedAttribute instead.", true)]
    ...
    /// </summary>
    [Obsolete("use MLContacts.TaggedAttributeList instead.", true)]
    ...
    /// </summary>
    [Obsolete("use MLContacts.Contact instead.", true)]
    ...
    public sealed partial class MLContacts : MLAPISingleton<MLContacts>
    {
        ...
        /// </summary>
        [Obsolete("Use DefaultFetchLimit instead")]
