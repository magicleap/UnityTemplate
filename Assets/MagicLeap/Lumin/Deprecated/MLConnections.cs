...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MLConnections.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    /// </summary>
    [Obsolete("Use MLConnections.InviteStatus instead.", true)]
    ...
    /// </summary>
    [Obsolete("Use MLConnections.InviteeFilter instead.", false)]
    ...
    public sealed partial class MLConnections : MLAPISingleton<MLConnections>
    {
        ...
        [Obsolete("use OnInvitationResultDelegate instead.", true)]
        ...
        /// </summary>
        [Obsolete("use OnInvitationResult instead.", true)]
        ...
        /// </returns>
        [Obsolete("Use MLConnections.SendInvite(uint, MLConnections.InviteeFilter, string, string) instead.", false)]
        ...
        [Obsolete("Use MLResult.CodeToString(resultCode) instead.", true)]
