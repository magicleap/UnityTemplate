...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLWorldRays.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed class MLWorldRays : MLRaycast
    {
        ...
        [Obsolete("Please use MLRaycast.OnRaycatResultDelegate(MLRaycast.ResultState, Vector3, Vector3, float) instead.", true)]
        ...
        /// </returns>
        [Obsolete("Please use MLRaycast.Raycast(QueryParams, MLRaycast.OnRaycatResultDelegate) instead.", true)]
