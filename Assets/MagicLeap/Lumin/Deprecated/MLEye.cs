...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MLEye.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    /// </summary>
    [Obsolete("This class has been deprecated, please use MLEyes.MLEye instead.", true)]
    ...
    public sealed partial class MLEyes : MLAPISingleton<MLEyes>
    {
        ...
        /// </summary>
        [Obsolete("This enumeration has been deprecated, please use MLEyes.Calibration instead.", true)]
