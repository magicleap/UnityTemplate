...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLMusicService.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLMusicService
    {
        ...
        /// </returns>
        [Obsolete("Please use the function MLMusicService.Start(string).", true)]
        ...
        /// </returns>
        [Obsolete("Please use the function MLMusicService.GetStatus(MLMusicService.Status).", true)]
        ...
        /// MLResult.Result will be <c>MLResult.Code.MediaGenericNoInit</c> if not connected.
        /// </returns>
        [Obsolete("Please use the function MLMusicService.GetError(MLMusicService.Error).", true)]
        ...
        /// MLResult.Result will be <c>MLResult.Code.PrivilegeDenied</c> if necessary privilege is missing.
        /// </returns>
        [Obsolete("Please use the function MLMusicService.GetMetadata(MLMusicService.Metadata, int).", true)]
