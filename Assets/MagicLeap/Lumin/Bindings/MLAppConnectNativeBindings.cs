...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file = "MLAppConnectNativeBindings.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap.Native
{
    ...
    public class MLAppConnectNativeBindings : MagicLeapNativeBindings
    {
        ...
        /// This Event will be triggered when there is an update on the connection status.
        /// </summary>
        public static event MLAppConnect.OnConnectionEventDelegate OnConnectionEvent;
        ...
        /// </returns>
        [DllImport(MLAppConnectDLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern MLResult.Code MLAppConnectUnregisterEventCallback([MarshalAs(UnmanagedType.LPStr)] string connectionName, ref ulong outCallbackHandle);
        ...
        /// </returns>
        [DllImport(MLAppConnectDLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern MLResult.Code MLAppConnectSendVideoFrame([MarshalAs(UnmanagedType.LPStr)] string connectionName, [MarshalAs(UnmanagedType.LPStr)] string pipeName, ref MLImageNativeBindings.MLImageNative video_frame);
        ...
        /// <param name="min_bytes">The minimum number of bytes to read before returning.</param>
        /// <param name="data">The data read from the pipe.</param>
        /// <param name="dataSize">The size of the data that was read.</param>
        /// <returns>
        /// MLResult_Ok if successfully read data, error code from #MLAppConnectResult otherwise.
        /// </returns>
        [DllImport(MLAppConnectDLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern MLResult.Code MLAppConnectReadData([MarshalAs(UnmanagedType.LPStr)] string connectionName, [MarshalAs(UnmanagedType.LPStr)] string pipeName, uint min_bytes, ref IntPtr data, ref ulong dataSize);
        ...
        /// <param name="connectionName">The name of the connection to read the data.</param>
        /// <param name="pipeName">The name of the pipe to read the data.</param>
        /// <param name="data">Address of data read from the pipe.</param>
        /// <param name="dataSize">The number of bytes to read from the pipe.</param>
        /// <param name="outDataPacketsRemaining">The number of packets remaining.</param>
        /// <returns>
        /// MLResult_Ok if successfully read data, error code from #MLAppConnectResult otherwise.
        /// </returns>
        [DllImport(MLAppConnectDLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern MLResult.Code MLAppConnectReadLargeData([MarshalAs(UnmanagedType.LPStr)] string connectionName, [MarshalAs(UnmanagedType.LPStr)] string pipeName, ref IntPtr data, ref ulong dataSize, ref ulong outDataPacketsRemaining);
        ...
        /// <summary>
        /// Block a pipe in the connection (stop sending and/or receiving data).
        /// </summary>
        /// <param name="connectionName">The name of the connection to read the data.</param>
        /// <param name="pipeName">An unique identifier for the pipe.</param>
        /// <returns>
        /// MLAppConnectResult_kOk if successfully blocked a pipe, error code from #MLAppConnectResult otherwise.
        /// </returns>
        [DllImport(MLAppConnectDLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern MLResult.Code MLAppConnectBlockPipe([MarshalAs(UnmanagedType.LPStr)] string connectionName, [MarshalAs(UnmanagedType.LPStr)] string pipeName);
        ...
        /// </returns>
        [DllImport(MLAppConnectDLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern MLResult.Code MLAppConnectUnblockPipe([MarshalAs(UnmanagedType.LPStr)] string connectionName, [MarshalAs(UnmanagedType.LPStr)] string pipeName);
        ...
        /// <param name="connectionName">The name of the connection.</param>
        /// <param name="pipeName"> An unique identifier for the pipe.</param>
        /// <param name="outPipeBlocked">Indicates if the pipe is blocked or not.</param>
        /// <returns>
        /// MLAppConnectResult_Ok if successfully unblocked a pipe, error code from #MLAppConnectResult otherwise.
        /// </returns>
        [DllImport(MLAppConnectDLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern MLResult.Code MLAppConnectIsPipeBlocked([MarshalAs(UnmanagedType.LPStr)] string connectionName, [MarshalAs(UnmanagedType.LPStr)] string pipeName, [MarshalAs(UnmanagedType.Bool)] ref bool outPipeBlocked);
        ...
        {
            MLResult callbackResult = MLAppConnect.RegisterEventCallback(connectionName);
        ...
        {
            Debug.LogErrorFormat("In OnEventCallbackInternal");
            ...
            {
                case MLAppConnect.EventType.ConnectionCreated:
                case MLAppConnect.EventType.ConnectionDeleted:
                case MLAppConnect.EventType.ConnectionFailed:
                    eventInfo.ConnectionInfo = (MLAppConnect.ConnectionEventInfo)Marshal.PtrToStructure(internalEventInfo.ConnectionInfo, typeof(MLAppConnect.ConnectionEventInfo));
                    MLThreadDispatch.Call(eventInfo.EventName, eventInfo.ConnectionInfo, OnConnectionEvent);
                    break;
                ...
                case MLAppConnect.EventType.MicUnmuted:
                    ...
                    break;
                case MLAppConnect.EventType.PipeBlocked:
                ...
                case MLAppConnect.EventType.PipeUnblocked:
