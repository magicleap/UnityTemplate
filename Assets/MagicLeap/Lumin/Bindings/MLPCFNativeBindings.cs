...
// ---------------------------------------------------------------------
// %COPYRIGHTBEGIN%
// <copyright file="MLPCFNativeBindings.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public partial class MLPersistentCoordinateFrames
    {
        private class NativeBindings : MagicLeapNativeBindings
        {
            ...
            /// </returns>
            [DllImport(MLPerceptionClientDll, CallingConvention = CallingConvention.Cdecl)]
            public static extern MLResult.Code MLPersistentCoordinateFramesGetFrameState(ulong trackerHandle, in MLCoordinateFrameUID cfuid, out FrameStateNative state);
