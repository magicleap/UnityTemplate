...
namespace UnityEngine.XR.MagicLeap.Native
{
    ...
    /// <summary>
    /// See ml_media_player.h for additional comments.
    /// </summary>
    public class MLMediaPlayerNativeBindings : MagicLeapNativeBindings
    {
        /// <summary>
        ...
        public static extern MLResult.Code InstantiateMediaPlayerContext(int mediaPlayerID, [MarshalAs(UnmanagedType.LPStr)] string mediaSource, MLMediaPlayer.ColorSpace colorSpace, MediaPlayerManagedCallbacks managedCallbacks, MLMediaPlayer.SharedType sharedType, [MarshalAs(UnmanagedType.LPStr)] string sessionID);
        ...
        /// </returns>
        [DllImport(MediaPlayerPluginDLL)]
        public static extern MLResult.Code SetAudioChannelPosition(int mediaPlayerID, uint channel, MagicLeapNativeBindings.MLVec3f position);
        ...
        /// </returns>
        [DllImport(MediaPlayerPluginDLL)]
        public static extern MLResult.Code GetAudioChannelPosition(int mediaPlayerID, uint channel, out MagicLeapNativeBindings.MLVec3f outPosition);
