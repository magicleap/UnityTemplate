...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLContactsNativeBindings.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap.Native
{
    ...
    /// </summary>
    public class MLContactsNativeBindings : MagicLeapNativeBindings
    {
        /// <summary>
        ...
        public struct TaggedAttributeNative
        {
            ...
            public MLContacts.TaggedAttribute Data
            {
                get
                {
                    ...
                    {
                        Tag = MLConvert.DecodeUTF8(this.Tag),
                        Value = MLConvert.DecodeUTF8(this.Value),
                    };
                }

                set
                {
                    this.Tag = MLConvert.EncodeToUnmanagedUTF8(value.Tag);
                    this.Value = MLConvert.EncodeToUnmanagedUTF8(value.Value);
                }
            }
        ...
        public struct TaggedAttributeListNative
        {
            ...
            public MLContacts.TaggedAttributeList Data
            {
                get
                {
                    ...
                    {
                        MLContactsNativeBindings.TaggedAttributeNative attribute = (MLContactsNativeBindings.TaggedAttributeNative)Marshal.PtrToStructure(Marshal.ReadIntPtr(walkPtr), typeof(MLContactsNativeBindings.TaggedAttributeNative));
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        int attributeSize = Marshal.SizeOf(typeof(MLContactsNativeBindings.TaggedAttributeNative));
                        ...
                        for (int i = 0; i < value.Count; ++i)
                        {
                            ...
                            MLContactsNativeBindings.TaggedAttributeNative internalAttribute = MLContactsNativeBindings.TaggedAttributeNative.Create();
            ...
            public void Clean()
            {
                ...
                for (int i = 0; i < listSize; ++i)
                {
                    ...
                    MLContactsNativeBindings.TaggedAttributeNative attribute = (MLContactsNativeBindings.TaggedAttributeNative)Marshal.PtrToStructure(structurePtr, typeof(MLContactsNativeBindings.TaggedAttributeNative));
                    attribute.Clean();
        ...
        public struct ContactNative
        {
            ...
            public MLContacts.Contact Data
            {
                get
                {
                    ...
                    {
                        Name = MLConvert.DecodeUTF8(this.Name),
                        ID = this.ID != IntPtr.Zero ? MLConvert.DecodeUTF8(this.ID) : null,
                ...
                set
                {
                    this.ID = value.ID != null ? MLConvert.EncodeToUnmanagedUTF8(value.ID) : IntPtr.Zero;
                    this.Name = value.Name != null ? MLConvert.EncodeToUnmanagedUTF8(value.Name) : IntPtr.Zero;
        ...
        public struct OperationResultNative
        {
            ...
            {
                MLResult.Code resultCode = MLContactsNativeBindings.MLContactsTryGetOperationResult(handle, out IntPtr operationResultPtr);
                if (resultCode != MLResult.Code.Pending)
                {
                    if (resultCode != MLResult.Code.ContactsCompleted)
                    {
                        MLPluginLog.ErrorFormat("MLContactsNativeBindings.GetManagedOperationResult failed to get operation result. Reason: {0}", MLResult.CodeToString(resultCode));
                    }

                    MLContactsNativeBindings.OperationResultNative internalResult = (MLContactsNativeBindings.OperationResultNative)Marshal.PtrToStructure(operationResultPtr, typeof(MLContactsNativeBindings.OperationResultNative));
                    MLContactsNativeBindings.ContactNative internalContact = (MLContactsNativeBindings.ContactNative)Marshal.PtrToStructure(internalResult.Contact, typeof(MLContactsNativeBindings.ContactNative));
        ...
        public struct ListResultNative
        {
            ...
            {
                MLResult.Code resultCode = MLContactsNativeBindings.MLContactsTryGetListResult(handle, out IntPtr operationResultPtr);
                if (resultCode != MLResult.Code.Pending)
                {
                    if (resultCode != MLResult.Code.ContactsCompleted)
                    {
                        MLPluginLog.ErrorFormat("MLContactsNativeBindings.GetManagedListResult failed to get list result. Reason: {0}", MLResult.CodeToString(resultCode));
                    }

                    MLContactsNativeBindings.ListResultNative internalListResult = (MLContactsNativeBindings.ListResultNative)Marshal.PtrToStructure(operationResultPtr, typeof(MLContactsNativeBindings.ListResultNative));
        ...
        public struct ContactListNative
        {
            ...
            public MLContacts.ContactList Data
            {
                get
                {
                    ...
                    for (int i = 0; i < listSize; ++i)
                    {
                        MLContactsNativeBindings.ContactNative contact = (MLContactsNativeBindings.ContactNative)Marshal.PtrToStructure(Marshal.ReadIntPtr(walkPtr), typeof(MLContactsNativeBindings.ContactNative));
        ...
        public struct SearchArgsNative
        {
            ...
            public SearchArgsNative(string searchQuery, MLContacts.SearchField searchFields, uint pageLength, string pageOffset)
            {
                ...
                this.Offset = pageOffset == string.Empty ? IntPtr.Zero : Marshal.StringToHGlobalAnsi(pageOffset);
                this.Limit = pageLength;
                this.Query = MLConvert.EncodeToUnmanagedUTF8(searchQuery);
