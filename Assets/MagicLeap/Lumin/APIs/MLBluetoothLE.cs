...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLBluetoothLE : MLAPISingleton<MLBluetoothLE>
    {
        ...
        /// <summary>
        /// Delegate describing the callback necessary to monitor acl state changes
        /// </summary>
        ...
        /// <param name="state">New conneciton state</param>
        public delegate void BLEConnectionStateChangedDelegate(Status status, ConnectionState state);
        ...
        /// <summary>
        /// Delegate that describes the callback invoked when a characteristc changes
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the user define callback invoked when acl states change
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the callback invoked when the Gatt descriptor is updated.
        /// </summary>
        public static event BLEGattDescriptorReadDelegate OnBluetoothGattDescriptorRead = delegate { };

        /// <summary>
        /// Gets or sets the callback invoked when the Gatt descriptor has been written
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the callback invoked when the Gatt connection interval changes.
        /// </summary>
        ...
        {
            /// <summary>
            /// An Acl connection was successful
            /// </summary>
            Connected = 0,
        ...
        /// <summary>
        /// Attribute permission for a Gatt client
        /// </summary>
        [Flags]
        public enum AttributePermissions
        {
            ...
            /// <summary>
            /// Read ecryption with Man-In-The-Middle protection
            /// </summary>
        ...
        /// <summary>
        /// Characteristic Properties for the Gatt
        /// </summary>
        [Flags]
        ...
        /// <returns>Returns the Gatt Client</returns>
        ...
        {
            MLBluetoothLE.Instance.GattDisconnect();
        ...
        /// </summary>
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult DiscoverServices()
        {
            return MLResult.Create(NativeBindings.MLBluetoothGattDiscoverServices());
        }

        /// <summary>
        /// Reads the RSSI for a connected remote device. The on_gatt_read_remote_rssi callback will 
        /// be invoked when the RSSI value has been read.
        /// </summary>
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult ReadRemoteRssi()
        {
        ...
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult GetServiceRecord(out Service[] serviceList)
        {
        ...
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult ReadCharacteristic(out Characteristic characteristic)
        {
            return MLResult.Create(NativeBindings.ReadCharacteristic(out characteristic));
        }
        ...
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult WriteCharacteristic(Characteristic characteristic)
        {
        ...
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult ReadDescriptor(out Descriptor descriptor)
        {
            return MLResult.Create(NativeBindings.ReadDescriptor(out descriptor));
        }
        ...
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult WriteDescriptor(Descriptor descriptor)
        {
        ...
        /// <returns>Returns <c>MLResult.Code.Ok</c> on success or an error on failure.</returns>
        public MLResult EnableCharacteristicNotification(Characteristic characteristic, bool enabled)
        {
        ...
        /// <summary>
        /// Disconnect from the Gatt client
        /// </summary>
        internal void GattDisconnect()
        {
        }

        /// <summary>
        /// Receives a timeslice for monitoring, not used.
        /// </summary>
        ...
        /// </summary>
        /// <param name="isSafeToAccessManagedObjects">Indicates wheter or not is should be considered safe to access managed objects</param>
        ...
        /// <summary>
        /// A structure for a node in the list of GATT characteristices
        /// </summary>
        public struct Characteristic
        {
            ...
            public Characteristic Create()
            {
                ...
                this.InstanceId = 0;
                this.Permissions = AttributePermissions.None;
                this.Properties = CharacteristicProperties.None;
                this.Buffer = new byte[MaxBufferSize];
