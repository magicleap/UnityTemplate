...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLFoundObjects.cs" company="Magic Leap">
//
                                ...
                                if (MLResult.IsOK(resultCode))
                                {
                                    ...
                                    if (foundObject.PropertyCount > 0)
                                    {
                                        ...
                                        for (uint propertyIndex = 0; propertyIndex < foundObject.PropertyCount; propertyIndex++)
                                        {
                                            ...
                                            if (MLResult.IsOK(resultCode))
                                            {
                                                properties.Add(new KeyValuePair<string, string>(objectProperty.Key.ToString(), objectProperty.Value.ToString()));
                                            }
                                            else
                                            {
