...
// ---------------------------------------------------------------------
// %COPYRIGHTBEGIN%
// <copyright file="MLResult.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public partial struct MLResult
    {
        ...
        public enum Code : int
        {
            ...
            /// </summary>
            [Obsolete("Use MLResult.Code.NotImplemented instead.", false)]
            ...
            /// </summary>
            AppConnectInviteSelectionCancelled,
        ...
        public static string CodeToString(MLResult.Code resultCode)
        {
            ...
            switch ((CodePrefix)((int)resultCode >> 16))
            {
                ...
                case CodePrefix.MLMediaResult:
                    codeString = Marshal.PtrToStringAnsi(MLMediaErrorNativeBindings.MLMediaResultGetString(resultCode));
                    break;
                ...
                case CodePrefix.MLIdentityResult:
                    codeString = Marshal.PtrToStringAnsi(MLIdentityNativeBindings.MLIdentityGetResultString(resultCode));
                    break;
                ...
                case CodePrefix.MLTokenAgentResult:
                    codeString = Marshal.PtrToStringAnsi(MLTokenAgentNativeBindings.MLTokenAgentGetResultString(resultCode));
                    break;
                ...
                case CodePrefix.MLContactsResult:
                    codeString = Marshal.PtrToStringAnsi(MLContactsNativeBindings.MLContactsGetResultString(resultCode));
                    break;
