...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public partial class MLMediaPlayer : MonoBehaviour
    {
        ...
        public MLResult SetSharingInfo(SharedType sharedType, string sessionID)
        {
            ...
            {
                MLPluginLog.ErrorFormat("MLMediaPlayer.SetSharingInfo failed because Follower must be video has been prepared.");
                return MLResult.Create(MLResult.Code.MediaGenericInvalidOperation);
            }

            return this.videoPlayerImpl.SetSharingInfo(this.MediaPlayerID, sharedType, sessionID);
        }
        ...
        public class Cea608CaptionLine
        {
            ...
            /// </summary>
            [Obsolete("This property has been marked for deprecation use DisplayString instead.")]
