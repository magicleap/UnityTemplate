...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLImageTracker.cs" company="Magic Leap">
//
...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public sealed partial class MLImageTracker : MLAPISingleton<MLImageTracker>
    {
        ...
        /// </summary>
        private MLImageTrackerNativeBindings.MLImageTrackerSettingsNative trackerSettings;
        ...
        {
            this.trackerSettings = MLImageTrackerNativeBindings.MLImageTrackerSettingsNative.Create();
            MLResult.Code result = MLImageTrackerNativeBindings.MLImageTrackerInitSettings(ref this.trackerSettings);
        ...
        {
            var settings = MLImageTrackerNativeBindings.MLImageTrackerSettingsNative.Create();
            MLResult.Code resultCode = MLImageTrackerNativeBindings.MLImageTrackerInitSettings(ref settings);
        ...
        {
            var settings = new MLImageTrackerNativeBindings.MLImageTrackerSettingsNative(customSettings);
        ...
        {
            return MLImageTracker.Settings.Create(Instance.trackerSettings);
        }
        ...
        public static MLResult UpdateTrackerSettings(MLImageTracker.Settings customSettings)
        {
            ...
            Instance.trackerSettings = new MLImageTrackerNativeBindings.MLImageTrackerSettingsNative(customSettings);

            MLResult.Code resultCode = MLImageTrackerNativeBindings.MLImageTrackerUpdateSettings(Instance.handle, ref Instance.trackerSettings);
            MLResult result = MLResult.Create(resultCode);
            if (!result.IsOk)
            {
                Instance.trackerSettings = new MLImageTrackerNativeBindings.MLImageTrackerSettingsNative(currentSettings);
            }
        ...
        protected override MLResult StartAPI()
        {
            ...
            MLResult.Code resultCode = MLImageTrackerNativeBindings.MLImageTrackerCreate(ref this.trackerSettings, ref this.handle);
            MLResult result = MLResult.Create(resultCode);
            if (result.IsOk)
            {
        ...
        private void DestroyNativeTracker()
        {
            ...
            MLResult.Code result = MLImageTrackerNativeBindings.MLImageTrackerDestroy(this.handle);
            if (result != MLResult.Code.Ok)
            {
        ...
        private MLResult SetTrackerStatusInternal(bool enabled)
        {
            ...
            MLResult.Code resultCode = MLImageTrackerNativeBindings.MLImageTrackerUpdateSettings(this.handle, ref this.trackerSettings);
            MLResult result = MLResult.Create(resultCode);
            if (!result.IsOk)
            {
        ...
        public struct Settings
        {
            ...
            /// <returns>An initialized version of this struct.</returns>
            public static Settings Create(MLImageTrackerNativeBindings.MLImageTrackerSettingsNative copiedSettings)
            {
                return new Settings
                {
