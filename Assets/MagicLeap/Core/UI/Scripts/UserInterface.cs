...
namespace MagicLeap
{
    ...
    public class UserInterface : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("The issues text element.")]
        private Text _issuesText = null;
        ...
        {
            get { return _issuesText.text; }
            set { _issuesText.text = value; }
        }
        ...
        public void HandleOnLogMessageReceived(string condition, string stackTrace, LogType type)
        {
            ...
            {
                IssuesText += string.Format("{0}{1}{1}", FormatText(condition), System.Environment.NewLine);
        ...
        {
            text = text.Replace("Error:", string.Format("<color=#{0}><b>Error:</b> </color><i>", ColorUtility.ToHtmlStringRGB(Color.red)));
            text += "</i>";
