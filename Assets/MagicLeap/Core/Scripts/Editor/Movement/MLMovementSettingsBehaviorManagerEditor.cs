...
// ---------------------------------------------------------------------
// %COPYRIGHT_BEGIN%
// <copyright file="MLMovementSettingsManagerBehaviorEditor.cs" company="Magic Leap">
//
...
{
    /// <summary>
    /// This class extends the inspector for the MLMovementSettingsManagerBehavior component, providing visual runtime information.
    /// </summary>
    [CustomEditor(typeof(MLMovementSettingsManagerBehavior))]
    public class MLMovementSettingsManagerBehaviorEditor : Editor
    {
        class Tooltips
        {
        ...
        void LayoutGUI()
        {
            MLMovementSettingsManagerBehavior myTarget = (MLMovementSettingsManagerBehavior)target;
