...
namespace MagicLeap.Core
{
    ...
    public class MLRaycastBehavior : MonoBehaviour
    {
        ...
        public delegate void OnRaycatResultDelegate(MLRaycast.ResultState state, Mode mode, Ray ray, RaycastHit hit, float confidence);
        public event OnRaycatResultDelegate OnRaycastResult;
